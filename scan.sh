...
rustscan -a $TARGET -r 0-8080 -- -oX $TARGET.xml
rustscan -a $TARGET -r 0-8080 -- -oN $TARGET.txt
...
if [ -z "$port_443" ];
	then
		...
		nmap -p443 --script=http-adobe-coldfusion-apsa1301 --script=http-affiliate-id --script=http-apache-negotiation --script=http-apache-server-status --script=http-aspnet-debug --script=http-auth-finder --script=http-auth --script=http-backup-finder --script=http-brute --script=http-coldfusion-subzero  --script=http-config-backup --script=http-default-accounts --script=http-frontpage-login --script=http-iis-short-name-brute --script=http-iis-webdav-vuln --script=http-methods --script=http-method-tamper --script=http-passwd --script=http-phpmyadmin-dir-traversal --script=http-php-version --script=http-put --script=http-robots.txt --script=http-server-header --script=http-shellshock --script=http-title --script=http-userdir-enum --script=http-vuln-cve2006-3392 --script=http-vuln-cve2009-3960 --script=http-vuln-cve2010-0738 --script=http-vuln-cve2010-2861 --script=http-vuln-cve2011-3192 --script=http-vuln-cve2011-3368 --script=http-vuln-cve2012-1823 --script=http-vuln-cve2013-0156 --script=http-vuln-cve2013-6786 --script=http-vuln-cve2013-7091 --script=http-vuln-cve2014-2126 --script=http-vuln-cve2014-2127 --script=http-vuln-cve2014-2128 --script=http-vuln-cve2014-2129 --script=http-vuln-cve2014-3704 --script=http-vuln-cve2014-8877 --script=http-vuln-cve2015-1427 --script=http-vuln-cve2015-1635 $TARGET -oN port443.log
		nmap  -p443 -script=ssl-heartbleed $TARGET	-oN port443.2.log
	fi
...
if [ -z "$port_8080" ];
	then
		...
		nmap -p8080 --script=http-adobe-coldfusion-apsa1301 --script=http-affiliate-id --script=http-apache-negotiation --script=http-apache-server-status --script=http-aspnet-debug --script=http-auth-finder --script=http-auth --script=http-backup-finder --script=http-brute --script=http-coldfusion-subzero  --script=http-config-backup --script=http-default-accounts --script=http-frontpage-login --script=http-iis-short-name-brute --script=http-iis-webdav-vuln --script=http-methods --script=http-method-tamper --script=http-passwd --script=http-phpmyadmin-dir-traversal --script=http-php-version --script=http-put --script=http-robots.txt --script=http-server-header --script=http-shellshock --script=http-title --script=http-userdir-enum --script=http-vuln-cve2006-3392 --script=http-vuln-cve2009-3960 --script=http-vuln-cve2010-0738 --script=http-vuln-cve2010-2861 --script=http-vuln-cve2011-3192 --script=http-vuln-cve2011-3368 --script=http-vuln-cve2012-1823 --script=http-vuln-cve2013-0156 --script=http-vuln-cve2013-6786 --script=http-vuln-cve2013-7091 --script=http-vuln-cve2014-2126 --script=http-vuln-cve2014-2127 --script=http-vuln-cve2014-2128 --script=http-vuln-cve2014-2129 --script=http-vuln-cve2014-3704 --script=http-vuln-cve2014-8877 --script=http-vuln-cve2015-1427 --script=http-vuln-cve2015-1635 $TARGET -oN port8080.log
	fi
...
if [ -z "$port_21" ];
	then
		...
		nmap -A -sV -sC -T5 -p21 --script="ftp-*" $TARGET -oN port21.log
	fi
...
if [ -z "$port_25" ];
	then
		...
		nmap -A -sV -sC -T5 -p25 --script="smtp-vuln-*" $TARGET -oN port25.log
		smtp-user-enum -M VRFY -U $USER_FILE -t $TARGET >> port25.log
		smtp-user-enum -M EXPN -U $USER_FILE -t $TARGET >> port25.log
		smtp-user-enum -M RCPT -U $USER_FILE -t $TARGET >> port25.log
	fi
...
then
	...
	nmap -sU -p 161 --script="snmp*" $TARGET -oN port161.log
fi
...
then
	...
	for a in `cat $SNMP_STRINGS`; do snmp-check -t $TARGET -c $a; done;
	nmap -A -p 162 --script="snmp*" $TARGET -oN port162.log
fi
...
then
	...
	nmap -A -sV -T5 --script="pop3--capabilities" --script="pop3-ntlm-info" -p 110 $TARGET -oN port110.log
fi
...
then
	...
	showmount -a $TARGET
	showmount -d $TARGET
	showmount -e $TARGET | tee -a port111.log
fi
...
then
	...
	rpcinfo -p $TARGET
	nmap -A -p 135 -T5 --script="rpc*" $TARGET -oN port135.log
fi
...
if [ -z "$port_445" ];
	then
		echo -e "$OKRED + -- --=[Port 445 closed... skipping.$RESET"
			...
			enum4linux -a $TARGET
			nmap -p139 $TARGET --script="smb-vuln*"	-oN port445.log
			fi
	else
		echo -e "$OKORANGE + -- --=[Port 445 opened... running tests...$RESET"
		enum4linux -a $TARGET
		nmap -p445 $TARGET --script="smb-vuln*"	-oN port445.log
	fi
...
then
	...
	nmap -A -sV -T5 --script="ftp-*" -p2121 $TARGET -oN port2121.log
	fi
...
then
	...
	nmap -A -sV --script="mysql*" -p 3306 $TARGET -oN port3306.log
...
if [ -z "$port_445" ];
	then
		...
		nmap -p445 --script=smb-brute --script-args smblockout=true,userdb=$USER_FILE,passdb=$MIN_PASS $TARGET -oN port445.log
	fi
